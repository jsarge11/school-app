...
componentDidMount() {
    axios.get('http://sargentassociates.com:4000/students?id=' + this.props.classroom.clsr_id).then(res => {
...
addStudent = () => {
    ...
    axios.post('http://sargentassociates.com:4000/students', newStudent).then(res => {
        this.props.setStudentList(res.data);
    })
}
